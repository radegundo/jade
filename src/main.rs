...
use crate::{ input::OwnInputPlugin, map::{ * }, ray::Hits };
use render::*;
...
fn main() {
    App::new()
        ...
        .insert_resource(Light {
            direction: Vec3::new(-0.5, -0.5, 0.6).normalize(),
            color: Color::WHITE,
            intensity: 1.5,
        })
        .run();
...
// NEW: map construction now needs an AssetServer to load textures, so it runs as a Startup system
fn setup_map(mut commands: Commands, asset_server: Res<AssetServer>) {
    commands.insert_resource(test_map(&asset_server));
}

pub fn test_map(asset_server: &AssetServer) -> Map {
    // Replace these paths with your actual texture files under assets/
    // let red_wall: Handle<Image> = asset_server.load("textures/red_wall.png");
    // let green_wall: Handle<Image> = asset_server.load("textures/green_wall.png");
    // let blue_wall: Handle<Image> = asset_server.load("textures/blue_wall.png");
    // let yellow_wall: Handle<Image> = asset_server.load("textures/yellow_wall.png");
    // let grey_wall: Handle<Image> = asset_server.load("textures/grey_wall.png");
    // let orange_wall: Handle<Image> = asset_server.load("textures/orange_wall.png");
    // let purple_wall: Handle<Image> = asset_server.load("textures/purple_wall.png");
    // let step_white: Handle<Image> = asset_server.load("textures/step_white.png");
    // let step_yellow: Handle<Image> = asset_server.load("textures/step_yellow.png");
    // let step_pink: Handle<Image> = asset_server.load("textures/step_pink.png");

    // let floor_pink: Handle<Image> = asset_server.load("textures/floor_pink.png");
    // let ceiling_red: Handle<Image> = asset_server.load("textures/ceiling_red.png");
    // let ceiling_orange: Handle<Image> = asset_server.load("textures/ceiling_orange.png");

    // let obstacle_wall: Handle<Image> = asset_server.load("textures/obstacle.png");
    // let obstacle_floor: Handle<Image> = asset_server.load("textures/obstacle_floor.png");
    // let obstacle_ceiling: Handle<Image> = asset_server.load("textures/obstacle_ceiling.png");
    let texture: Handle<Image> = asset_server.load("texture.png");

    Map {
        sectors: vec![
            SectorBuilder::new(0, 0.0, 25.0, texture.clone(), texture.clone(), Some(vec![0]))
            ...
            SectorBuilder::new(1, 10.0, 20.0, texture.clone(), texture.clone(), None)
            ...
            SectorBuilder::new(2, -10.0, 25.0, texture.clone(), texture.clone(), None)
        ...
        obstacle_sectors: vec![
            ObstacleSectorBuilder::new(0, 0.0, 5.0, texture.clone(), texture.clone())
